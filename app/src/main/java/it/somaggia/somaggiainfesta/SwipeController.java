...
public class SwipeController extends Callback {
    ...
    SwipeController(RecyclerItemTouchHelperListener listener){
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (viewHolder != null) {
            final View foregroundView = ((DynamicCommandsAdapter.ActiveCommandViewHolder) viewHolder).viewForeground;
